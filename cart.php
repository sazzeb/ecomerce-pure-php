    ...
    <div class="col-md-12">
        ...
        <?php else : ?>
            <table class="table table-bordered table-condensed table-striped">
                <thead><th>#</th><th>Item</th><th>Price</th><th>Quantity</th><th>Size</th><th>Sum Total</th></thead>
                <tbody>
                    <?php
                        ...
                        <div class="modal-body">
                            <div class="row">
                               <form action="thankYou.php" method="post" id="payment-form">
                                   ...
                                   <input type="hidden" name="description" value="<?=$item_count.'item'.(($item_count>1)?'s':'').' From E-commerce Shop';?>">
                                   <div id="step1" style="display: block;">
                                       ...
                                       <div class="form-group col-md-6">
                                           ...
                                           <div class="form-group col-md-6">
                                               ...
                                               <input class="form-control" id="state" name="state" type="text" data-stripe="address_street">
                                           </div>
                                           <div class="form-group col-md-6">
